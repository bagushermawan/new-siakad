<script>
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        ...
                        var totalEkskul = parseInt($('#totalEkskul').data('total'));
                        console.log(totalEkskul);
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        Swal.fire('Sukses!', 'Berhasil hapus ekskul.', 'info');
                    },
                    error: function(response) {
                        Swal.fire('Gagal!', 'Terjadi kesalahan saat menghapus ekskul.',
                            'error');
                    }
                });
            }
    ...
    function simpan(id = '') {
        ...
        if (id === '') {
            var_url = 'ekskul';
            var_type = 'POST';
            successMessage = 'Berhasil tambah ekskul.';
        } else {
            var_url = 'ekskul/' + id;
            var_type = 'PUT';
            successMessage = 'Berhasil update ekskul.';
        }
