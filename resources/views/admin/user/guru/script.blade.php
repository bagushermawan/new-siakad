            ...
            buttons: [{
                ...
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        ...
                        var totalSantri = parseInt($('#totalGuru').data('total'));
                        ...
                        // Tambahkan kondisi JavaScript berdasarkan nilai total_prestasi
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    $.ajax({
                                        url: "/delete-all-guru", // Ganti dengan URL backend Anda
                                        ...
                                        success: function(response) {
                                            ...
                                            if (response.success) {
                                                ...
                                                $('#myTable').DataTable()
                                                    .ajax.reload();
                                                Swal.fire("Deleted!",
                                                    "All users with role 'guru' deleted successfully.",
                                                    "success");
                                            } else {
                                                Swal.fire(
                                                    "Error!",
            ...
            initComplete: function() {
                ...
                api
                    ...
                    .each(function(colIdx) {
                        ...
                        if (colIdx === 0 || colIdx === 6 || colIdx === 7 || colIdx === 8 || colIdx === 4 || colIdx === 9) {
