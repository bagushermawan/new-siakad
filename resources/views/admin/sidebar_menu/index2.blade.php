...
<body>
    ...
    <h1>Sidebar Menus</h1>
    <a href="{{ route('sidebarmenu.create') }}" class="btn btn-primary mb-3">Tambah Menu</a>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $menu->roles }}</td>
                <td>
                    <a href="{{ route('sidebarmenu.edit', $menu) }}" class="btn btn-sm btn-warning">Edit</a>

                    <form action="{{ route('sidebarmenu.destroy', $menu) }}" method="POST" style="display:inline-block" onsubmit="return confirm('Hapus menu ini?')">
                        @csrf
                        @method('DELETE')
