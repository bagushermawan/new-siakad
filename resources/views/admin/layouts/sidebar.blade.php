        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li
                    ...
                    <ul class="submenu ">
                        <li class="submenu-item  {{ request()->routeIs('ekskul.*') ? 'active' : '' }}">
                            <a href="{{ route('ekskul.index') }}" class="submenu-link">Ekstrakulikuler</a>
                        </li>
                        ...
                        <li class="submenu-item  {{ request()->routeIs('jadwalmatapelajaran.*') ? 'active' : '' }}">
                            <a href="{{ route('jadwalmatapelajaran.index') }}" class="submenu-link">Jadwal Mata
                                Pelajaran</a>
                        </li>
                ...
                @if (auth()->user()->hasRole('admin'))
                    ...
                    <li
                        class="sidebar-item  {{ request()->routeIs('role.*', 'permission.*') ? 'active' : '' }} has-sub">
                        <a href="#" class='sidebar-link'>
